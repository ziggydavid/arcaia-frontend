              ...
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    We utilise cutting-edge technologies to eliver carefully crafted custom solutions for our clients.
                    </p>
                </div>
              </div>
            </div>
              ...
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">
                    ...
                    Awesome and creative designs
                    </h4>
                  <p className="m-0 text-sm">
                    We deliver awesome and creative design that suits the need of our clients and meets the industry standard of top quality
                       </p>
                </div>
              </div>
            </div>
            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="400">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    Customer satisfaction is our commitment, we are committed to serving you better, with 24/7 customer support team.
                      </p>
                </div>
              </div>
            </div>
